package net.mcreator.jellyfish;
...
import net.mcreator.jellyfish.init.JellyfishModTabs;
import net.mcreator.jellyfish.init.JellyfishModItems;
...
@Mod("jellyfish")
public class JellyfishMod {
	public static final Logger LOGGER = LogManager.getLogger(JellyfishMod.class);
	public static final String MODID = "jellyfish";

	public JellyfishMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		JellyfishModItems.REGISTRY.register(modEventBus);
		JellyfishModEntities.REGISTRY.register(modEventBus);
		JellyfishModTabs.REGISTRY.register(modEventBus);
